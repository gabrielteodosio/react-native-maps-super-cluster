 ...
 */
export const itemToGeoJSONFeature = ({ attributes }) => ({
  type: 'Feature',
  geometry: {
    type: 'Point',
    coordinates: [attributes.location.longitude, attributes.location.latitude]
  },
  properties: { point_count: 0, item: { ...attributes } } // eslint-disable-line camelcase
})
